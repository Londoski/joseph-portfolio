...
function GlassTestimonial({ t }: { t: Testimonial }) {
  return (
    <article
      className="flex-shrink-0 w-[85vw] sm:w-[70vw] md:w-[55vw] lg:w-[42vw] xl:w-[36vw] rounded-3xl p-8 md:p-10 border relative"
      style={{
    ...
    >
      ...
      <p className="text-lg md:text-xl leading-relaxed text-white font-light italic min-h-[180px] md:min-h-[200px]">
        {"\u201C" + t.content + "\u201D"}
      </p>
      ...
      <div className="mt-8 pt-6 border-t border-white/15 flex items-center gap-4">
        {t.image ? (
          <img
            src={t.image}
            alt={t.clientName}
            className="w-14 h-14 rounded-full object-cover border border-white/25"
          />
        ) : (
          <div className="w-14 h-14 rounded-full bg-[rgba(232,122,45,0.25)] border border-[rgba(232,122,45,0.5)] flex items-center justify-center flex-shrink-0">
        ...
        <div>
          <p className="text-base font-semibold text-white">{t.clientName}</p>
